...
| 字段 | 值 |
|------|-----|
| **最新 Session** | Session 183（按首轮真人试玩校准：修马里奥被封坑里、马里奥变慢、开局 4 秒、被火烧晕 1.2 秒、封路墙 3.5 秒） |
| **日期** | 2026-09-26 |
...
| 优先级 | 描述 | 状态 |
|--------|------|------|
| **最高** | **S183 校准验收**：H10 重跑仍 5/5；真人 5 局看"来得及埋伏/机关有效/不再封坑"，看"想再来"是否从 2 上升。 | 沙箱编译通过；未经 Unity |
