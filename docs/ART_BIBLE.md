...
> **⚠️ 详细架构已抽离至 `docs/STYLE_CONSISTENCY_ARCHITECTURE.md`**
> 
> 关于如何通过“语义锁定、结构引导、模型适配”三层体系确保单套画风的绝对一致性，以及如何在 Unity 引擎中通过 `LevelThemeProfile` 或 `SpriteAtlas Variant` 优雅地管理和切换多套画风版本，请**统一参考《画风一致性与多版本切换架构指南》**。
