...
从策划生产视角看，项目已经具备第一版完整闭环。关卡可以用 **ASCII 文本与片段库**快速生成；商业素材可以通过 **Asset Import Pipeline** 从外部图片变成可复用 Object/Prefab；已有白盒物体可以通过 **Apply Art to Selected** 直接换皮，并保留碰撞、陷阱、可操控等行为。[1] [2] [4]

<details open>
<summary><b>📋 核心能力清单</b></summary>
...
<details open>
<summary><b>🛠️ 2.1 做关卡：文字矩阵优先，Scene 拖拽只做局部微调</b></summary>
...
<details open>
<summary><b>👗 2.2 换素材：新对象走导入管线，旧白盒走 Apply Art</b></summary>
...
<details open>
<summary><b>🤖 2.3 增机制：大白话触发，AI 后台补字典、组件、测试和说明</b></summary>
...
<details>
<summary><b>📝 命名规范速查表 (点击展开)</b></summary>
...
| “我已经导入了 swim 素材，帮我写个游泳机制” | 生成流体触发器、Mario 浮力组件、状态机挂接 |
